...
class RatingAdmin(admin.ModelAdmin):
    ...
    # ── List view ──
    list_display        = ('student', 'stars_display', 'target_type', 'object_id', 'active_badge', 'created_at')
    ...
    # ── Detail view ──
    readonly_fields     = ('content_object_display', 'active_updated_at', 'created_at', 'updated_at', 'target_type')
    save_on_top         = True
    ...
    fieldsets = (
        (_('Who & What'), {
            'fields': ('student', 'content_type', 'object_id', 'content_object_display'),
        ...
        (_('Status'), {
            ...
            'description': _('Soft-delete control. Inactive ratings are excluded from averages.'),
        }),
        (_('Timestamps'), {
    ...
    def soft_delete(self, request, queryset):
        ...
        self.message_user(request, _(f'{updated} rating(s) soft-deleted.'), messages.SUCCESS)
    ...
    def restore(self, request, queryset):
        ...
        self.message_user(request, _(f'{updated} rating(s) restored.'), messages.SUCCESS)
