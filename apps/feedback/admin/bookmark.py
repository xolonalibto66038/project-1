...
class BookmarkAdmin(admin.ModelAdmin):
    ...
    # ── List view ──
    list_display        = ('student', 'target_type', 'target_name_display', 'object_id', 'has_note', 'created_at')
    ...
    def hard_delete(self, request, queryset):
        ...
        queryset.delete()
        self.message_user(request, _(f'{count} bookmark(s) permanently deleted.'), messages.WARNING)
