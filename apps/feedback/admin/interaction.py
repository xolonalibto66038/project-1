...
class InteractionAdmin(admin.ModelAdmin):
    ...
    # ── List view ──
    list_display        = ('student', 'interaction_badge', 'target_type', 'object_id', 'created_at')
    ...
    # ── Detail view ──
    readonly_fields     = ('content_object_display', 'target_type', 'created_at', 'updated_at')
    save_on_top         = True
    ...
    def interaction_badge(self, obj):
        ...
        return format_html(
            ...
            '{} {}</span>',
            color, icon, obj.get_interaction_type_display(),
        )
    ...
    def content_object_display(self, obj):
        ...
        if target is None:
            return format_html('<span style="color:#dc3545;">Object no longer exists</span>')
    ...
    def hard_delete(self, request, queryset):
        ...
        queryset.delete()
        self.message_user(request, _(f'{count} interaction(s) deleted.'), messages.WARNING)
