    ...
    SECTIONS = [
        {
            ...
            "content": [
                ...
                _(
                    "These terms apply to all users including students, teachers, and guests."
                ),
                _(
        ...
        },
        {
            ...
            "content": [
                ...
                _(
                    "You must not attempt to gain unauthorised access to any part of the platform or its systems."
                ),
                _(
                    "You must not use the platform to spam, harass, or impersonate other users."
                ),
                _(
                    "You must not use automated tools, bots, or scrapers to access platform content without permission."
                ),
                _(
        ...
        },
        {
            ...
            "content": [
                ...
                _(
                    "Content that violates copyright or intellectual property laws will be removed without notice."
                ),
            ],
        },
        {
            ...
            "content": [
                _(
                    "Teachers are responsible for the accuracy and quality of the content they upload."
                ),
                _(
                    "Teachers must ensure that uploaded content complies with the Algerian national curriculum where applicable."
                ),
                _(
                    "Teachers must not upload content that infringes on third-party intellectual property."
                ),
                _(
                    "Verified teacher status may be revoked if content standards are repeatedly violated."
                ),
                _(
                    "Teachers are responsible for maintaining professional conduct in all interactions with students on the platform."
                ),
            ],
        },
        {
            ...
            "content": [
                _(
                    "Students must use the platform in good faith for genuine learning purposes."
                ),
                _(
                    "Students must not share quiz answers, cheat on assessments, or engage in academic dishonesty."
                ),
                _("Students must treat teachers and other users with respect."),
                _(
                    "Students are responsible for their own learning progress and engagement with the platform."
                ),
            ],
        },
        {
        ...
        },
        {
            ...
            "content": [
                ...
                _(
                    "We reserve the right to suspend or permanently terminate your account for violations of these terms."
                ),
                _(
                    "Upon termination, your access to the platform will be revoked immediately."
                ),
                _(
                    "Content you have uploaded may be retained or removed at our discretion following termination."
                ),
                _(
        ...
        },
        {
            ...
            "content": [
                _(
                    "These Terms of Service are governed by the laws of the People's Democratic Republic of Algeria."
                ),
                _(
                    "Any disputes arising from these terms shall be subject to the exclusive jurisdiction of Algerian courts."
                ),
                _(
        ...
        },
        {
            ...
            "content": [
                _(
                    "If you have questions about these Terms of Service, please contact us via the contact form or by email."
                ),
