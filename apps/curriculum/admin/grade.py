...
class GradeAdmin(admin.ModelAdmin):
    ...
    list_display        = ('short_name', 'name', 'level', 'order', 'slug', 'specialty_count', 'subject_count', 'edit_button', 'delete_button')
    ...
    def duplicate_view(self, request, pk):
        ...
        if obj:
            ...
            obj.save()
            self.message_user(request, _('Grade duplicated successfully.'), messages.SUCCESS)
