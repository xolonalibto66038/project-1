...
class SpecialtyAdmin(admin.ModelAdmin):
    ...
    list_display        = ('short_name', 'name', 'grade', 'level_display', 'slug', 'edit_button', 'delete_button')
    ...
    fieldsets = (
        (_('General Information'), {
            ...
            'description': _('Specialty (filière) details. Only applicable to Secondaire grades.'),
        }),
    )
