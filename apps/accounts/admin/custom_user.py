...
class CustomUserAdmin(UserAdmin):
    ...
    # ── List view ──
    list_display        = (
        'avatar_display', 'full_name_display', 'email',
        'role_badge', 'wilaya', 'is_verified',
        'is_active', 'date_joined',
    )
    list_display_links  = ('avatar_display', 'full_name_display')
    list_filter         = (
        'role', 'is_verified', 'is_active',
        'is_staff', 'gender', 'wilaya',
        'date_joined',
    )
    ...
    # ── Detail view ──
    readonly_fields     = (
        'avatar_display', 'date_joined', 'last_login',
    ...
    def unverify_users(self, request, queryset):
        ...
        self.message_user(request, _(f'{updated} user(s) unverified.'), messages.WARNING)
    ...
    def deactivate_users(self, request, queryset):
        ...
        self.message_user(request, _(f'{updated} user(s) deactivated.'), messages.WARNING)
