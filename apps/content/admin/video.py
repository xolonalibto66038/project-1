...
class VideoResourceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            _("Video"),
            {
                ...
                "description": _(
                    "Paste the full YouTube URL. The video ID is extracted automatically."
                ),
            },
        ),
        (
    ...
    def activate(self, request, queryset):
        ...
        self.message_user(
            request, _(f"{updated} video(s) activated."), messages.SUCCESS
        )
    ...
    def deactivate(self, request, queryset):
        ...
        self.message_user(
            request, _(f"{updated} video(s) deactivated."), messages.SUCCESS
        )
    ...
    def duplicate_view(self, request, pk):
        ...
        if obj:
            ...
            obj.save()
            self.message_user(
                request, _("Video duplicated successfully."), messages.SUCCESS
            )
