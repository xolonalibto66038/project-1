...
class ChapterAdmin(admin.ModelAdmin):
    ...
    ordering = (
        "grade_subject__grade__level__order",
        "grade_subject__grade__order",
        "order",
    )
    list_per_page = 20
    ...
    fieldsets = (
        (
            _("Location"),
            {
                ...
                "description": _(
                    "Where this chapter sits in the curriculum hierarchy."
                ),
            },
        ),
        (
    ...
    def course_count(self, obj):
        ...
        url = (
            reverse("admin:content_course_changelist") + f"?chapter__id__exact={obj.pk}"
        )
    ...
    def activate(self, request, queryset):
        ...
        self.message_user(
            request, _(f"{updated} chapter(s) activated."), messages.SUCCESS
        )
    ...
    def deactivate(self, request, queryset):
        ...
        self.message_user(
            request, _(f"{updated} chapter(s) deactivated."), messages.SUCCESS
        )
    ...
    def duplicate_view(self, request, pk):
        ...
        if obj:
            ...
            obj.save()
            self.message_user(
                request, _("Chapter duplicated successfully."), messages.SUCCESS
            )
